...
func TestInt64Field2024(t *testing.T) {
	t.Parallel()

	res := testutil.RunGeneratorForFiles(t, defaultgen.GenerateFile, testDataFS, "testdata/int64_2024.proto")
	testutil.RunTestInE2ERunner(t, res, `
		package main
