...
func TestSint64Field2024(t *testing.T) {
	t.Parallel()

	res := testutil.RunGeneratorForFiles(t, envgen.GenerateFile, testDataFS, "testdata/sint64_2024.proto")
	testutil.RunTestInE2ERunner(t, res, `
		package main
