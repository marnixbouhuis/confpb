...
func TestNestedMessageField2024(t *testing.T) {
	t.Parallel()

	res := testutil.RunGeneratorForFiles(t, envgen.GenerateFile, testDataFS, "testdata/message_2024.proto")
	testutil.RunTestInE2ERunner(t, res, `
		package main
		...
		func TestRepeated(t *testing.T) {
			...
			protoEqual(t, Nested_builder{
				List: []*Message{
					Message_builder{Test: "foobar"}.Build(),
					Message_builder{Test: "second"}.Build(),
					Message_builder{Test: "third"}.Build(),
				},
			}.Build(), actual)
		}
...
func TestRecursiveNestedMessageField2024(t *testing.T) {
	t.Parallel()
	...
	testutil.RunTestInE2ERunner(t, res, `
		...
		func TestNormal(t *testing.T) {
			...
			protoEqual(t, NestedRecursive_builder{
				Test: "level_0",
				Message: NestedRecursive_builder{
					Test: "level_1",
					Message: NestedRecursive_builder{
						Test: "level_2",
					}.Build(),
		...
		func TestWithPresence(t *testing.T) {
			...
			protoEqual(t, NestedRecursive_builder{
				Test: "level_0",
				WithPresence: NestedRecursive_builder{
					Test: "level_1",
					WithPresence: NestedRecursive_builder{
						Test: "level_2",
					}.Build(),
		...
		func TestRepeated(t *testing.T) {
			...
			protoEqual(t, NestedRecursive_builder{
				Test: "level_0",
				List: []*NestedRecursive{
					NestedRecursive_builder{
						Test: "level_1_item_1",
					}.Build(),
					NestedRecursive_builder{
						Test: "level_1_item_2",
						List: []*NestedRecursive{
							NestedRecursive_builder{Test: "level_1_item_2_item_1"}.Build(),
							NestedRecursive_builder{Test: "level_1_item_2_item_2"}.Build(),
						},
					}.Build(),
				},
			}.Build(), actual)
		...
		func TestOneOfOneOptionSet(t *testing.T) {
			...
			protoEqual(t, NestedRecursive_builder{
				Test: "level_0",
				OneofOptionA: NestedRecursive_builder{
					Test: "level_1",
					OneofOptionA: NestedRecursive_builder{
						Test: "level_2",
					}.Build(),
...
func TestEmbeddedNestedMessageField2024(t *testing.T) {
	t.Parallel()
	...
	testutil.RunTestInE2ERunner(t, res, `
		...
		func TestNormal(t *testing.T) {
			...
			protoEqual(t, WithEmbedded_builder{
				Message: WithEmbedded_EmbeddedMessage_builder{
					Test: "foobar",
				}.Build(),
			}.Build(), actual)
		}
		...
		func TestWithPresence(t *testing.T) {
			...
			protoEqual(t, WithEmbedded_builder{
				WithPresence: WithEmbedded_EmbeddedMessage_builder{
					Test: "foobar",
				}.Build(),
			}.Build(), actual)
		}
		...
		func TestRepeated(t *testing.T) {
			...
			protoEqual(t, WithEmbedded_builder{
				List: []*WithEmbedded_EmbeddedMessage{
					WithEmbedded_EmbeddedMessage_builder{Test: "foobar"}.Build(),
					WithEmbedded_EmbeddedMessage_builder{Test: "second"}.Build(),
					WithEmbedded_EmbeddedMessage_builder{Test: "third"}.Build(),
				},
			}.Build(), actual)
		}
		...
		func TestOneOfOneOptionSet(t *testing.T) {
			...
			protoEqual(t, WithEmbedded_builder{
				OneofOptionA: WithEmbedded_EmbeddedMessage_builder{
					Test: "foobar",
				}.Build(),
			}.Build(), actual)
		}
